...
Suite *suite_div(void) {
  ...
  tcase_add_test(tc, s21_div_2);  //она уходит в бесконечность
  tcase_add_test(
      tc, s21_div_3);  //вырублено было      уходит в бесконечность после правки
  tcase_add_test(tc, s21_div_4);
  tcase_add_test(tc, s21_div_5);  //вырублено было
  tcase_add_test(tc, s21_div_6);  //уходит в бесконечность после правки
  tcase_add_test(tc, s21_div_null);
