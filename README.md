...
В данном проекте представлены функции для работы с большими числами (от положительных 79,228,162,514,264,337,593,543,950,335 до отрицательных 79,228,162,514,264,337,593,543,950,335.). Реализованы арифметические операторы, операторы сравнения, округления и преобразования в другие численные типы данных.
